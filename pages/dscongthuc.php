 <head>
    <style>
        @media screen and (min-width: 768px) {
            .recipelisting .cmp-recipe-listing-wrapper .cmp-recipe-listing-container .cmp-recipe-listing-items-container .cmp-recipe-listing-item {
                -webkit-box-flex:0;
                 ...
                 <div class="product__sidebar">
                     ...
                     <div class="shop-category product__sidebar-single">
                         ...
                         <ul class="list-unstyled">
                             <li><a href="#">Bread & Bakery <span>(9)</span></a></li>
                                                 ...
                                                 <div class="cmp-card-wrapper">
                                                     <div class="cmp-recipe-image-wrapper">
                                                         <div class="cmp-recipe-listing-image-container">
                                                             <picture>
                                                                 <a href="index.php?tkh=chitietcongthuc"><img
                                                                         src="pages/imgweb/banhxeo.jpg"
                                                                         class="cmp-recipe-listing-image"
                                                                         style="height: 200px; width:100%; object-fit: cover;" /></a>
                                                             </picture>
                                                         </div>
                                                     </div>
                                                     <h3 class="cmp-recipe-listing-title">
                                                         <a href="index.php?tkh=chitietcongthuc"
                                                             class="cmp-recipe-listing-link">Lẩu bắp bò nhúng hành răm -
                                                             Món ngon bổ dưỡng cuối
                                                             tuần</a>
                                                     </h3>
